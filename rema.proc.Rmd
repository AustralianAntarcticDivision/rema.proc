...
Proportion of tiles done vs tiles-including-rock is ~.23, and each "rock tile" compresses to about 2.5Mb (it's a single Byte, and compressed by DEFLATE) so we end up with about 380 rock tiles at 1Gb total. 
...
text(coordinates(polytiles)[1:logn, ], lab = 1:logn, cex = 0.5, col = "hotpink")
